...
# R1-013 aisport 配置越界堆写

## 1. 一句话结论

aisport 配置越界堆写。代码路径和根因已确认，但尚未完成无歧义的真机闭环。
...
证据索引见 `证据/材料清单.md`。源材料：`AUD-r3-aisport-config-oob-heapwrite`。未提交的大型或敏感证据统一登记在仓库根目录 `材料清单/未提交材料.csv`。
