...
# G2-023 config_set 路径写

## 1. 一句话结论

config_set 路径写。原始假设已被后续实验或可达性复核推翻；保留失败过程用于防止重复研究。
...
证据索引见 `证据/材料清单.md`。源材料：未动态闭环 21、后续真机复核。未提交的大型或敏感证据统一登记在仓库根目录 `材料清单/未提交材料.csv`。
